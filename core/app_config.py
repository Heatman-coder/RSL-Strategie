...
def build_base_config(script_dir: str, reports_dir: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "financedatabase_snapshot_file": get_path(script_dir, os.path.join("tools", "fd_all_equities_full.csv")),
        "financedatabase_use_live_package": True,
        "financedatabase_require_isin": True,
        "financedatabase_require_metadata": True,
        "financedatabase_allow_otc": False,
        "financedatabase_max_additions": 4000,
